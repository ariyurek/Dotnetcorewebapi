...
#pragma warning disable
    ...
    {
        private string _baseUrl = "https://localhost:44320";
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200")
                        {
                            ...
                            var result_ = default(System.Collections.Generic.ICollection<TodoItem>);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<System.Collections.Generic.ICollection<TodoItem>>(responseData_, _settings.Value);
                                return result_;
                            }
